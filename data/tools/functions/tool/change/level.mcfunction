...
execute if score @s level matches 6 if predicate tools:tools/axe run loot replace entity @s weapon.mainhand loot tools:tools/diamond/axe
...
execute if score @s level matches 6 if predicate tools:tools/pickaxe run loot replace entity @s weapon.mainhand loot tools:tools/diamond/pickaxe
...
execute if score @s level matches 6 if predicate tools:tools/hoe run loot replace entity @s weapon.mainhand loot tools:tools/diamond/hoe
...
execute if score @s level matches 6 if predicate tools:tools/shovel run loot replace entity @s weapon.mainhand loot tools:tools/diamond/shovel
...
execute if score @s level matches 6 if predicate tools:tools/sword run loot replace entity @s weapon.mainhand loot tools:tools/diamond/sword
